...
export default function SiteFooter() {
  return <footer className="bg-[#212121] text-white"><div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-3 lg:px-8">
    <div><Image src="https://media.base44.com/images/public/6a75f1f68617f8a7b5abfa7c/fcca44e48_WhatsAppImage2025-06-20at112612.jpeg" alt="Hands of Hope logo" className="mb-4 h-12 w-12 overflow-hidden rounded-full" fittingType="fill" focalPointX={0.5} focalPointY={0.35} /><h2 className="font-heading text-2xl">Hands of Hope</h2><p className="mt-3 text-sm leading-7 text-white/70">Supporting people. Strengthening families. Building communities.</p></div>
  ...
  </div><div className="border-t border-white/10 px-5 py-5 text-center text-xs text-white/50">© {new Date().getFullYear()} Duncan Village Safe Park and Drop-in Centre. Children are the future.</div></footer>;
}